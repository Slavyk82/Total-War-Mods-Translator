...
void main() {
  setUp(() async {
    ...
    // Give the grid a wide enough viewport so the five cards fit without
  ...
  testWidgets('renders 5 action cards with correct values', (tester) async {
